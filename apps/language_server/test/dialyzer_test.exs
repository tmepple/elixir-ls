defmodule ElixirLS.LanguageServer.DialyzerTest do
  ...
  test "reports dialyxir_short formatted error in umbrella project", %{server: server} do
    in_fixture(__DIR__, "dialyzer_umbrella", fn ->
      file_a = SourceFile.path_to_uri(Path.absname("apps/app1/lib/a.ex"))
